 ...
 */
final class Version20250301145022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier ADD nomproduits VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE produit ADD image VARCHAR(50) DEFAULT NULL, ADD conssoles VARCHAR(255) NOT NULL, ADD jeuxvideo VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier DROP nomproduits');
        $this->addSql('ALTER TABLE produit DROP image, DROP conssoles, DROP jeuxvideo');
    }
}
